...
// visually distinguished (indigo fill vs. a neutral outline).
            ...
            className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-semibold border transition-colors ${
              isActive
                ...
                : needsAttention
                  ...
                  : "bg-muted text-muted-foreground border-border hover:bg-indigo-50 dark:hover:bg-indigo-500/10 hover:text-indigo-700 dark:hover:text-indigo-300 hover:border-indigo-100 dark:hover:border-indigo-400/20"
            }`}
          >
            {CHIP_LABELS[filter]}
            <span
